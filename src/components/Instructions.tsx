  ...
  return (
    <Fragment>
      ...
      <p className="CresentText">
        Cresent Co. has an expense approval system. A user can see all expenses as well as filter expenses by emplouee.
        You are a manager and you need to approve the transactions made by your employees.
        <span className="CresentBreak--s" />
